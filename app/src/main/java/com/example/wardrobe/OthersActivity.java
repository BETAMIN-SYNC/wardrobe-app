...
public class OthersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root = FirebaseDatabase.getInstance().getReference("Others");
        ...
        if (currentUser != null) {
            root.orderByChild("userId").equalTo(currentUser.getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(OthersActivity.this, "Failed to fetch images.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK && data != null) {
            ...
            if (imageUri != null) {
                ...
                Toast.makeText(OthersActivity.this, "Please Select an Image", Toast.LENGTH_SHORT).show();
            }
        }
    }
                            ...
                            if (modelId != null) {
                                root.child(modelId).setValue(gallery)
                                        .addOnSuccessListener(aVoid -> {
                                            progressBar.setVisibility(View.INVISIBLE);
                                            Toast.makeText(OthersActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                                            imageView.setImageResource(R.drawable.add);
                                        })
                                        .addOnFailureListener(e -> {
                                            progressBar.setVisibility(View.INVISIBLE);
                                            Toast.makeText(OthersActivity.this, "Uploading Failed!", Toast.LENGTH_SHORT).show();
                                        });
                            }
                        }
                    });
